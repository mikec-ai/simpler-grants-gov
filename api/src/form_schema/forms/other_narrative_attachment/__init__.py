...
_portable = load_form("other-narrative-attachments")
...
OtherNarrativeAttachment_v1_2.form_json_schema = FORM_JSON_SCHEMA
OtherNarrativeAttachment_v1_2.form_ui_schema = FORM_UI_SCHEMA
OtherNarrativeAttachment_v1_2.form_rule_schema = FORM_RULE_SCHEMA
del _mod
del _portable
