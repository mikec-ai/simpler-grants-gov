"""DB-backed lifecycle gates for the unregistered portable SF-424B profiles."""
...
from tests.src.form_schema.form_spec.test_sf424b_portable import (
    RELEASABLE_PROFILES,
    VALID_RESPONSE,
)
...
def test_sf424b_profile_save_and_reload(
...
@pytest.mark.parametrize("form_id", RELEASABLE_PROFILES)
def test_sf424b_profile_submission_records_acceptance_event(
    enable_factory_create: Any,
    db_session: Any,
    form_id: str,
) -> None:
